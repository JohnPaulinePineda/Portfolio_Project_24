---
title: 'R : Methods : Exploring Dichotomization Thresholding Strategies for Optimal Classification'
...
|      **[B.1]** 1/4 response = <span style="color: #FF0000">Log_Solubility_Class</span> variable (factor)
...
|      **[B.2]** 3/4 predictors = All remaining variables (0/3 factor + 3/3 numeric)
|     
| 
...
|      **[A.3]** <span style="color: #FF0000">NumBonds</span> variable (51 outliers detected)
|
...
|      **[A.3]** <span style="color: #FF0000">NumBonds</span> variable (numeric)
|
...
|
| **[A]** The logistic regression model from both the <mark style="background-color: #CCECFF">**stats**</mark> and <mark style="background-color: #CCECFF">**caret**</mark> packages was implemented. 
|
...
(ClassificationMetrics_Plot <- dotplot(Criterion ~ ClassificationMetrics,
                           ...
                           groups = Set,
                           main = "Dichotomization Threshold Criterion Performance Comparison",
