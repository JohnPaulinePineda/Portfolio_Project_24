...
|
| **[A]** The <span style="color: #0000FF">CB</span> threshold criterion from the <mark style="background-color: #CCECFF">**OptimalCutpoints**</mark> package was used which applied the ROC curve point closest to the observed prevalence.
|  
| **[B]** The threshold criterion requires to set 1 parameter:
|      **[B.1]** <span style="color: #FF0000">costs.ratio</span> = ratio between two computations: cost difference of the false positive and true negative; and the cost difference of the false negative and true positive, set at 2.0
| 
| **[C]** The determined optimal dichotomization threshold and corresponding classification metrics are summarized as follows:
|      **[C.1]** Log Solubility Class Probability Threshold = 0.64163
|      **[C.2]** Apparent Sensitivity = 0.90458
